...
class FusionModel(nn.Module):
    ...
    def single_fusion_cross_attention_forward(self,
        ...
        k_target = rope_apply(k_target, target_grid_sizes, target_freqs, ref_lengths=target_ref_lengths, freqs_scaling=target_freqs_scaling)
        
        target_x = backend_attention(q, k_target, v_target, k_lens=target_seq_lens)
    ...
    def single_fusion_block_forward(self,
        ...
        audio_y = audio_block.self_attn(
            ...
            audio_freqs, ref_lengths=audio_ref_lengths, freqs_scaling=audio_freqs_scaling)
        with torch.amp.autocast('cuda', dtype=torch.bfloat16):
        ...
        vid_y = vid_block.self_attn(
            ...
            vid_freqs, ref_lengths=vid_ref_lengths)
    ...
    def forward(
        ...
        audio, audio_e, audio_kwargs = self.audio_model.prepare_transformer_block_kwargs(
            x=audio, t=t, context=audio_context, seq_len=audio_seq_len, ref_lengths=ref_audio_lengths, freqs_scaling=freqs_scaling)
